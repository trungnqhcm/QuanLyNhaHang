...
{
    public partial class FundamentalModelsSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleFood = table.Column<int>(nullable: false),
                    RoleTable = table.Column<int>(nullable: false),
                    RoleIngredient = table.Column<int>(nullable: false),
                    RolePrepareFood = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodCategoryId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoneyReceive = table.Column<decimal>(nullable: false),
                    MoneyReturn = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodWithOrders", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodWithOrders_FoodId",
                table: "FoodWithOrders",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodWithOrders_OrderId",
                table: "FoodWithOrders",
                column: "OrderId");
